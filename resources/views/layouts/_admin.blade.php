...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('admin_template/css/AdminLTE.min.css')}}">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
  folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="{{asset('admin_template/css/skins/_all-skins.min.css')}}">
  <!-- iCheck -->
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
                ...
                <li>
                  ...
                  <ul class="menu">
                    <li><!-- start message -->
                      <a href="#">
                        <div class="pull-left">
                          <img src="{{asset('admin_template/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image">
                        </div>
                        <h4>
                          Support Team
                    ...
                    <li>
                      <a href="#">
                        <div class="pull-left">
                          <img src="{{asset('admin_template/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                        </div>
                        <h4>
                          admin_template Design Team
                    ...
                    <li>
                      <a href="#">
                        <div class="pull-left">
                          <img src="{{asset('admin_template/img/user4-128x128.jpg')}}" class="img-circle" alt="User Image">
                        </div>
                        <h4>
                          Developers
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{asset('admin_template/img/user2-160x160.jpg')}}" class="user-image" alt="User Image">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class=""><a href="#"><i class="fa fa-plus"></i>Insert category</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="javascript:;">
            ...
            <ul class="treeview-menu">
              ...
              <li class=""><a href="#"><i class="fa fa-plus"></i>Insert product</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="javascript:;">
            ...
            <ul class="treeview-menu">
              <li><a href="#"><i class="fa fa-circle-o"></i>List orders</a></li>
              <li class=""><a href="#"><i class="fa fa-plus"></i>xxx</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="javascript:;">
            ...
            <ul class="treeview-menu">
              ...
              <li class=""><a href="#"><i class="fa fa-plus"></i>Insert admin</a></li>
            </ul>
          </li>
...
<!-- ./wrapper -->
  ...
  <script src="{{asset('admin_template/plugins/bootbox/bootbox.min.js')}}"></script>
  <!-- AdminLTE App -->
